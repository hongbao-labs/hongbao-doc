...
No third-party audit yet. The team has a security background and the contract was designed and reviewed by a senior auditor internally. A third-party audit is planned; timing is gated on order volume and client requirements, and we will publish the report here once it is available. The code is fully public at [github.com/hongbao-labs/contracts](https://github.com/hongbao-labs/contracts) — you are welcome to review it yourself or commission an independent audit.
