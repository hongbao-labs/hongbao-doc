...
| **Client** (Web / Android / iOS) | Guides the cardholder through scanning, Bluetooth pairing, entering the recipient address, and authorizing the signature | Provided by Hongbao |
| **Standard contract** | The on-chain custody layer. Binds the card address, releases funds after verifying the signature; the issuer reclaims after expiry | Open-source; anyone can deploy / fork / extend |
