---
title: Turn on-chain incentives into an offline campaign only real users can join
...
On-chain actions (Factory / Pool deployment, approve, batchDepositWithTasks, claimTask, withdrawExpired) are all wrapped behind buttons in the Web Dapp — no scripting needed. Full flow in the [end-to-end guide](guide.md); developer teams refer to the open-source repo ([TBD: GitHub]).
