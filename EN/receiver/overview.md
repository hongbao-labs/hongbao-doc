...
Physically, it's about the size of a bank card, just a little thicker. Inside, you'll find:
...
- **A private key lives inside the chip**, generated randomly by the chip itself at the factory and permanently sealed in hardware. We, the issuer, the manufacturer — nobody, not even you — can ever export it.
...
Nothing. Download the Hongbao App ([Android APK](https://github.com/hongbao-labs/HB_Android/releases/download/v1.0.4/hongbao-v1.0.4-release.apk) — iOS & Web coming soon) and follow the steps.
