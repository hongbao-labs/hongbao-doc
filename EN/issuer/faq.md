...
No third-party audit yet. The team has a security background and the contract was designed and reviewed by a senior auditor internally. At this stage we have determined that a third-party audit is not cost-justified; we will revisit based on order volume and client requirements. The code is fully public at [github.com/hongbao-labs/contracts](https://github.com/hongbao-labs/contracts) — you are welcome to review it yourself or commission an independent audit.
...
At the contract level, yes (an "open mode" Pool). The Web Dapp does not currently expose this flow directly. Developer teams who need this should interact at the contract layer — see the open-source contract repo ([github.com/hongbao-labs/contracts](https://github.com/hongbao-labs/contracts)).
...
Business and purchasing: partnerships@hongbao.digital (see [contact.md](../contact.md))
Technical questions: dev@hongbao.digital or [GitHub Issues](https://github.com/hongbao-labs/contracts/issues)
