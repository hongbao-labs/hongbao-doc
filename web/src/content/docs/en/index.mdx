---
title: Hongbao Overview
description: Hongbao on-chain asset distribution protocol overview
draft: false
---
...
| You are | Read |
|---|---|
| Someone who received a card | [Receiver](receiver/overview) — how to claim, why it's safe, what to do if you lose it |
| A project / company / retail user who wants to distribute assets with Hongbao | [Issuer](issuer/overview) — how it differs from gift cards, the workflow, customization options |
